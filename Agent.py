...
selected_datasets = [
    "/home/yl3427/cylab/Fairness/glaucoma_df.csv",
    "/home/yl3427/cylab/Fairness/mimic_df.csv",
]
...
# ['slo_fundus', 'maritalstatus', 'ethnicity', 'language', 'gender',
#        'race', 'age', 'glaucoma']
...
class BaselineZS(LLMAgent):
    def __init__(self):
        system_prompt = (
            ...
            "With the features provided, decide if the eye shows glaucomatous damage.\n\n"
            "Return three fields in this order, as valid JSON:\n"
            " 1) Rationale – a short, step‑by‑step explanation of your reasoning\n"
            " 2) Prediction – \"Glaucoma\" or \"Non‑Glaucoma\"\n"
    ...
    async def analyze_note(self, note: str, problem: str):
        ...
        user_prompt = (
            "You are an ophthalmology assistant.\n"
            "Given objective image‑derived metrics and basic demographics, judge whether the eye shows glaucomatous damage.\n\n"
